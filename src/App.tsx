...
import ProducerProfile from "./pages/producer-management/ProducerProfile";
  ...
  return (
    <AppLayout>
      <Switch>
        ...
        <ProtectedRoute path="/producer/:producerId" component={ProducerProfile} requiredRole="admin" />
